    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 py-12 flex-1 justify-center max-w-[380px] mx-auto">
        ...
        <h1 className="text-[32px] sm:text-[36px] font-black text-white leading-[1.2] mb-6 drop-shadow-md">
          Consult Expert Hair Doctor in Karaikudi
        </h1>

        {/* Subtext */}
        <p className="text-[17px] text-white/90 mb-10 leading-relaxed font-medium">
          Best Hair treatment in Karaikudi
        </p>

        {/* CTA button - Shimmer style as in StickyBottomCta, but smaller font */}
        <a
          href="tel:+919575156789"
          className="btn-shimmer flex flex-col items-center justify-center text-white py-[12px] px-[30px] rounded-full shadow-lg transition-all active:scale-95"
        >
          <span className="flex items-center justify-center gap-3 text-[15px] font-bold">
            ...
            Speak to Hair Doctor Instantly
          </span>
          <span className="text-[16px] font-extrabold tracking-wide mt-[2px]">
            +91 9575156789
          </span>
        </a>
      </div>
