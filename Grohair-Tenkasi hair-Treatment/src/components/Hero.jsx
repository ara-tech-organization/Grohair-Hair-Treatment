...
export default function Hero() {
  ...
  function handleCall() {
    ...
    fetch('https://adgrohairgloskintenkasi.in/api/email.php', options).catch(() => {})

    window.location.href = 'tel:+918110956789'
  }
