...
export default function Header() {
  return (
    <header className="flex items-center justify-between px-3 min-[375px]:px-4 py-0 bg-white border-b border-gray-200 sticky top-0 z-50">
      {/* Logo */}
      <img 
        src={logoImg} 
        alt="Grohair" 
        className="h-[28px] min-[375px]:h-[32px] min-[425px]:h-[36px] sm:h-[55px] w-auto min-w-[40px] min-[375px]:min-w-[46px] min-[425px]:min-w-[52px] sm:min-w-[80px] object-contain"
      />

      <div className="flex items-center gap-4 min-[375px]:gap-5 min-[425px]:gap-7 h-full">
