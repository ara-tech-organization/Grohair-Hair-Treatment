...
export default function Header() {
  return (
    <header className="flex items-center justify-between px-4 py-0 bg-white border-b border-gray-200 sticky top-0 z-50">
      {/* Logo */}
      <img src={logoImg} alt="Grohair" style={{ height: 'clamp(52px, 16vw, 68px)', width: 'auto', objectFit: 'contain' }} />
